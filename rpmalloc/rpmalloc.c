...
/* Suppress compiler warning 4 unused vars, e.g., unused function args
 */
...
#else
    WARN_SUPPRESS_UNUSED(heap_size_class);
#endif
    WARN_SUPPRESS_UNUSED(class_idx);
...
#else
    WARN_SUPPRESS_UNUSED(first_class);
...
rpmalloc_linker_reference(void) {
    WARN_SUPPRESS_UNUSED(_rpmalloc_initialized);
}
