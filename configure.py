...
if not generator.target.is_android() and not generator.target.is_ios():
	...
	rpmallocwrap_so = generator.sharedlib(module = 'rpmalloc', libname = 'rpmallocwrap', sources = ['rpmalloc.c'], variables = {'defines': ['ENABLE_DYNAMIC_LINK=1', 'ENABLE_PRELOAD=1', 'ENABLE_OVERRIDE=1']})
	rpmallocwrap_lib = generator.lib(module = 'rpmalloc', libname = 'rpmallocwrap', sources = ['rpmalloc.c'], variables = {'defines': ['ENABLE_OVERRIDE=1']})
